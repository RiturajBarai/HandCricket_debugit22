...
public class MainActivity2 extends AppCompatActivity {
    ...
    public void onClick(int k){
        ...
        if(rand==k && flag==0){
            Toast.makeText(this, "BATTER OUT \nYOU ARE BOWLING", Toast.LENGTH_SHORT).show();
            flag=1;
            userStat.setText("You are bowling");
        }
        else if(rand==k && flag==1){
            Toast.makeText(this, "BATTER OUT YOU WON", Toast.LENGTH_SHORT).show();
            ...
            runsP2+=rand;
            if(runsP2>runsP1){
                Toast.makeText(this, "TARGET REACHED YOU LOST", Toast.LENGTH_SHORT).show();
